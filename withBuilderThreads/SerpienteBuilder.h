#ifndef SERPIENTE_BUILDER_H
#define SERPIENTE_BUILDER_H

#include "EnemigoBuilder.h"
#include "Serpiente.h"

class SerpienteBuilder : public EnemigoBuilder {
public:
    SerpienteBuilder() {
        enemigo = std::make_unique<Serpiente>();
    }
