#ifndef PEZ_GLOBO_BUILDER_H
#define PEZ_GLOBO_BUILDER_H

#include "EnemigoBuilder.h"
#include "PezGlobo.h"

class PezGloboBuilder : public EnemigoBuilder {
public:
    PezGloboBuilder() {
        enemigo = std::make_unique<PezGlobo>();
    }
